...
class AllamoConfiguration:
    ...
    pad_token_id: int = -1
    eos_token_id: int = -1
    dynamic_attention_mask: bool = False
    ...
    def load_values(self):
        ...
        parser.add_argument('--log_checkpoint_md5_on_load', action='store_true', help='When loading a checkpoint, log its MD5 checksum')
        parser.add_argument('--log_checkpoint_md5_on_epoch', action='store_true', help='When saving a checkpoint at the end of an epoch, log its MD5 checksum')
        parser.add_argument('--ignore_last_checkpoint_backup', action='store_true', help='Ignores preserving a copy of the last checkpoint version by overwriting it')
        ...
        parser.add_argument('--save_optimizer_checkpoint', action='store_true', help='Enable saving optimizer checkpoint')
        ...
        parser.add_argument('--save_best_checkpoint', action='store_true', help='Enable saving the best checkpoint when evaluating model')
        parser.add_argument('--save_checkpoint_on_dataset_reload', action='store_true', help='Enable model checkpoint saving on dataset reload')
        parser.add_argument('--distributed_checkpoint', action='store_true', help='Use PyTorch Distributed Checkpoint (DCP)')
        ...
        parser.add_argument('--eval_only', action='store_true', help='Exit right after the first evaluation. Indicates no training.')
        ...
        parser.add_argument('--dataset_seq_train', action='store_true', help='Iterate dataset sequentially')
        parser.add_argument('--dataset_seq_train_start', type=int, help='Position in tokens to start with')
        parser.add_argument('--dataset_buffer', action='store_true', help='Enable buffer for dataset samples')
        ...
        parser.add_argument('--batch_size_schedule', action='store_true', help='Enable linear batch_size scheduler')
        ...
        parser.add_argument('--grad_accum_schedule', action='store_true', help='Enable linear gradient_accumulation_steps scheduler')
        ...
        parser.add_argument('--bias', action='store_true', help='Enable bias globally. Helpful in finetuning process')
        ...
        parser.add_argument('--compile', action='store_true', help='Whether to use PyTorch 2.0 to compile the model to be faster')
        ...
        parser.add_argument('--pad_token_id', type=int, help="Enables padding and specifies the token id used for padding in sequences")
        parser.add_argument('--eos_token_id', type=int, help="Specifies the token id used for generating attention masks")
        parser.add_argument('--dynamic_attention_mask', action='store_true', help='Whether to generate attention mask based on provided eos token id')
        parser.add_argument('--weighted_loss', action='store_true', help='Whether to use weighted loss if available')
        parser.add_argument('--weighted_loss_method', type=str, choices=['allamo', 'openchat'], help='How weighted loss is calculated')
        parser.add_argument('--adaptive_learning_rate', action='store_true', help='Whether to use adaptive learning rate')
