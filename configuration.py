...
class AllamoConfiguration:
    ...
    def load_values(self):
        ...
        parser.add_argument('--dpo_strategy', type=str, choices=['DPO', 'DPOP'], help='Specifies DPO strategy')
        parser.add_argument('--dpop_lambda', type=float, help='Temperature parameter for penalty in the DPOP loss, typically something in the range of 5 to 500')
